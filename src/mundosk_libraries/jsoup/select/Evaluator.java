package mundosk_libraries.jsoup.select;

import mundosk_libraries.jsoup.helper.Validate;
import mundosk_libraries.jsoup.nodes.Comment;
import mundosk_libraries.jsoup.nodes.Document;
import mundosk_libraries.jsoup.nodes.DocumentType;
import mundosk_libraries.jsoup.nodes.Element;
import mundosk_libraries.jsoup.nodes.Node;
import mundosk_libraries.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<mundosk_libraries.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (mundosk_libraries.jsoup.nodes.Attribute attribute : values) {
