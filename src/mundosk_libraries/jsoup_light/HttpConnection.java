package mundosk_libraries.jsoup_light;
...
import static mundosk_libraries.jsoup_light.Connection.Method.HEAD;

/**
 * Implementation of {@link Connection}.
 * @see mundosk_libraries.org.jsoup.Jsoup#connect(String)
 */
            ...
            try {
                ...
                if (contentType != null && xmlContentTypeRxp.matcher(contentType).matches()) {
                    ...
                    if (req instanceof HttpConnection.Request && !((Request) req).parserDefined) {
                        ...
                        throw new IllegalStateException("XML stuff reached");
                    }
                }
