...
public class CondBeyondBorder extends Condition {
	...
	public boolean check(Event arg0) {
		...
		if (loc.getSingle(arg0).getX() > posx || loc.getSingle(arg0).getX() < negx) {
			result = true;
		}
		if (loc.getSingle(arg0).getZ() > posz || loc.getSingle(arg0).getZ() < negz) {
			result = true;
		}
		return result;
	}
