...
public class ExprSizeOfBorder extends SimpleExpression<Double>{
	...
	public void change(Event arg0, Object[] delta, Changer.ChangeMode mode){
		if (mode == ChangeMode.SET){
			if (seconds != null) {
				BorderManager.changeSize(border.getSingle(arg0), ((Number)delta[0]).doubleValue(), new Long(seconds.getSingle(arg0).getMilliSeconds()/1000).doubleValue());
		...
		if (mode == ChangeMode.ADD) {
			if (seconds != null) {
				BorderManager.changeSize(border.getSingle(arg0), ((Number)delta[0]).doubleValue() + border.getSingle(arg0).getWorldBorder().getSize(), new Long(seconds.getSingle(arg0).getMilliSeconds()/1000).doubleValue());
		...
		if (mode == ChangeMode.REMOVE) {
			if (seconds != null) {
				BorderManager.changeSize(border.getSingle(arg0), border.getSingle(arg0).getWorldBorder().getSize() - ((Number)delta[0]).doubleValue(), new Long(seconds.getSingle(arg0).getMilliSeconds()/1000).doubleValue());
