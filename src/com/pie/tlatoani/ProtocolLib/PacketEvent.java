...
public class PacketEvent extends Event implements Cancellable{
    ...
    private com.comphenix.protocol.events.PacketEvent packetEvent;
        ...
        if (!cleanlist.isEmpty()) {
            ...
            protocolManager.addPacketListener(new PacketAdapter(Mundo.instance, ListenerPriority.NORMAL, packettypearray) {
                ...
                public void onPacketReceiving(com.comphenix.protocol.events.PacketEvent event) {
                    PacketEvent evt = new PacketEvent(event);
    ...
    public PacketEvent(com.comphenix.protocol.events.PacketEvent event) {
