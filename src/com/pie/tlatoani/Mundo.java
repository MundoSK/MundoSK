...
public class Mundo extends JavaPlugin{
	...
	public void onEnable(){
		...
		Skript.registerEffect(EffMovePage.class, "move (page[s] %-number% [to %-number%]|last [%-number%] page[s]) (of|in) %itemstack% (-1圩ront|-1圩orward[s]|1在ack[ward[s]]) %number%");
		...
		Skript.registerCondition(CondProbability.class, "%number%[1吒\%] prob[ability]");
